...
(M.anime = (function () {
  ...
  function o(t) {
    return B.arr(t)
      ? t
      : (B.str(t) && (t = s(t) || t), t instanceof NodeList || t instanceof HTMLCollection ? [].slice.call(t) : [t]);
  }
  function a(t, e) {
  ...
  function k(t, i) {
    ...
    return o(t)
      .map(function (t, e) {
        return (
          (e = e ? 0 : i.delay), (t = B.obj(t) && !B.pth(t) ? t : { value: t }), B.und(t.delay) && (t.delay = e), t
        );
      })
      .map(function (t) {
        return c(t, e);
  ...
  function O(t) {
    ...
    function e(t) {
      ...
      (n <= a || !e) && (k.began || ((k.began = !0), p('begin')), p('run')),
        i < a && a < e
          ? c(a)
          : (a <= i && 0 !== s && (c(0), o && v()), ((e <= a && s !== e) || !e) && (c(e), o || v())),
        p('update'),
        e <= t &&
          (k.remaining
        ...
        if (0 <= a && a <= 1 && 0 <= l && l <= 1) {
          ...
          return function (t) {
            ...
            if (0.001 <= n) {
              ...
              for (
                var i = e, e = e + 0.1, o = 0;
                0 < (n = u((s = i + (e - i) / 2), a, l) - t) ? (e = s) : (i = s), 1e-7 < Math.abs(n) && ++o < 10;
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (i.length) {
                    ...
                    l.remove(n[0]),
                      n.css({ display: 'block', overflow: 'hidden', height: 0, paddingTop: '', paddingBottom: '' });
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (e.length && !e[0].classList.contains('active')) {
                    if (
                      ('function' == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, e[0]),
  ...
  (function (i) {
    ...
    function n(t) {
      ...
      null !== e &&
        (g.show(t, e),
        'ontouchstart' in i &&
          (e.addEventListener('touchend', g.hide, !1), e.addEventListener('touchcancel', g.hide, !1)),
        ...
        function n(t, e) {
          ...
          return (
            ...
            i.$slides.find('img').each(function (t) {
              ...
              s(t).attr('src') !== e &&
                (s(t).css('background-image', 'url("' + s(t).attr('src') + '")'), s(t).attr('src', e));
            }),
            i._setupIndicators(),
            i.$active
              ...
              },
              {
                ...
                value: function () {
                  this.options.showClearBtn &&
                    (g(this.clearBtn).css({ visibility: '' }), (this.clearBtn.innerHTML = this.options.i18n.clear)),
              ...
              },
              {
                ...
                value: function (t, e, i, n, s, o) {
                  ...
                  for (
                    ...
                    l >= u.minYear &&
                      d.push(
                        '<option value="' + l + '" ' + (l === i ? 'selected="selected"' : '') + '>' + l + '</option>'
                      );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    (this.options.twelveHour &&
                      void 0 !== t[1] &&
                      (0 < t[1].toUpperCase().indexOf('AM') ? (this.amOrPm = 'AM') : (this.amOrPm = 'PM'),
                ...
                value: function (t) {
                  ...
                  c !== this.center &&
                    ...
                    'function' == typeof this.oneTimeCallback &&
                      (this.oneTimeCallback.call(this, k[0], this.dragged), (this.oneTimeCallback = null));
                },
              },
              {
                      ...
                      this.$selectOptions.each(function (t) {
                        if (d(t).is('option')) {
                          ...
                          d(n.dropdownOptions).append(
                            d('<li class="optgroup"><span>' + t.getAttribute('label') + '</span></li>')[0]
                          ),
                            i.each(function (t) {
                ...
                value: function () {
                  for (var t in ((this._keysSelected = {}), this._valueDict)) {
                    ...
                    d(e.optionEl).find('input[type="checkbox"]').prop('checked', i),
                      i
                        ? (this._activateOption(d(this.dropdownOptions), d(e.optionEl)), (this._keysSelected[t] = !0))
